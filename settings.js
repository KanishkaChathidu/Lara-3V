...
module.exports = {
SESSION_ID: process.env.SESSION_ID || "nAxRnKiB#rkZCInIfJIEJY0OhPKmiHlJoKU8gaZdYQ5K2n1hR_pQ", // Add your session id
PREFIX: process.env.PREFIX || ".",
MODE: process.env.MODE || "inbox",  //public | private | inbox | group
OWNER_NUMBER: process.env.OWNER_NUMBER || "94787197055",
DEV: process.env.DEV || "94787197055",
